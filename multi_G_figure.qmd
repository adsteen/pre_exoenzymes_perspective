...
The model is thus:
![](https://latex.codecogs.com/svg.image?\frac{dG_l}{dt}&space;=&space;k_l&space;G_l&space;-&space;k_{l\rightarrow&space;r}G_l&space;\\\frac{dG_r}{dt}&space;=&space;k_rG_r&space;&plus;&space;k_{l\rightarrow&space;r}G_l)
